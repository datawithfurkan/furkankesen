...
Minimal static personal contact page for `furkankesen.com`.

## Update contact details

Edit `index.html` and replace:

- `imfurkankesen@gmail.com`
- `https://www.linkedin.com/in/furkankesen/`
...
4. Add `furkankesen.com` as the custom domain in the GitHub Pages settings before changing DNS.
5. In Namecheap DNS, remove any default parked/redirect records and point the domain to GitHub Pages:
   ...
   - `CNAME` record for `www` to `datawithfurkan.github.io`
6. Do not add wildcard DNS records like `*.furkankesen.com`.
